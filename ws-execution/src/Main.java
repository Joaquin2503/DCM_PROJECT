...
public class Main {
	...
	public static final void main(String[] args) throws Exception {
		...
		List<String> params = Arrays.asList(
				"http://musicbrainz.org/ws/1/artist/?name=", null);

		// Testing without loading the description of the WS
		/**
		 * WebService ws=new WebService("mb_getArtistInfoByName",params); String
		...
		String fileWithCallResult = ws.getCallResult("Snoop Dogg");
		System.out.println("The call is   **" + fileWithCallResult + "**");
		String fileWithTransfResults = ws
				.getTransformationResult(fileWithCallResult);
		ArrayList<String[]> listOfTupleResult = ParseResultsForWS.showResults(
